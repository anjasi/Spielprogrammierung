...
Shoes.show_log
	...
	animation=animate(20) do 			# Dauerschleife die immer die Schlange zeichnet
		 if schlange.get_spielvariable==1 then	# Wenn das Spiel läuft
			...
			#@slot = schlange.get_schlange
			#@slot.remove						# lösche schlange	
			schlange.check_ergebnis()
