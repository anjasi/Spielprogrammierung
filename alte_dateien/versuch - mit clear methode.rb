...
#------------------------------------------------------------------------------------------------------------------	
	def verschiebe_schlange()
		...
		if @@verlaengerung==0 then
			...
			#@test.replace "Pos der letzten Stelle: #{@@schlange.last}"		# Testausgabe
...
#------------------------------------------------------------------------------------------------------------------	
	...
	def zeichne_fressen()
		@fressen = rect(@x_fressen*10,@y_fressen*10,@a,@a)
	end
...
Shoes.show_log
	...
	animate(@level) do 
		if @spielvariable==true then	
			...
			schlange.zeichne_auf_spielfeld()
